...
tls::reload_callback2 wrap_reload_callback(tls::reload_callback cb) {
...
public:
    ...
    public:
        ...
        reloading_builder(credentials_builder b, reload_callback2 cb, reloadable_credentials_base* creds, delay_type delay)
    ...
    reloadable_credentials_base(credentials_builder builder, reload_callback2 cb, delay_type delay = default_tolerance)
...
public:
    reloadable_credentials(credentials_builder builder, reload_callback2 cb, Base b, delay_type delay = default_tolerance)
        : Base(std::move(b))
...
future<shared_ptr<tls::certificate_credentials>> tls::credentials_builder::build_reloadable_certificate_credentials(reload_callback2 cb, std::optional<std::chrono::milliseconds> tolerance) const {
...
future<shared_ptr<tls::server_credentials>> tls::credentials_builder::build_reloadable_server_credentials(reload_callback2 cb, std::optional<std::chrono::milliseconds> tolerance) const {

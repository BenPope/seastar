...
namespace tls {
    ...
    using reload_callback2 = std::function<void(const std::unordered_set<sstring>&, const certificate_credentials&, std::exception_ptr)>;
    ...
    public:
        ...
        future<shared_ptr<certificate_credentials>> build_reloadable_certificate_credentials(reload_callback2, std::optional<std::chrono::milliseconds> tolerance = {}) const;
        ...
        future<shared_ptr<server_credentials>> build_reloadable_server_credentials(reload_callback2, std::optional<std::chrono::milliseconds> tolerance = {}) const;
    private:
